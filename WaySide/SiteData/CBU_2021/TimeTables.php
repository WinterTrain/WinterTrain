...
"12" => [
  ...
  "group" => "",
  "routeTable" => [
    ["time" => "", "start" => "S5", "dest" => "S15", "condition" => "", "delay" => ""],
    ["time" => "", "start" => "S7", "dest" => "S15", "condition" => "", "delay" => ""],
    ["time" => "", "start" => "S15", "dest" => "S20", "condition" => "", "delay" => "40"],
    ["time" => "", "start" => "S20", "dest" => "BS3", "condition" => "", "delay" => "40"],
//    ["time" => "", "start" => "BS3", "dest" => "", "condition" => "E", "delay" => ""],
//    ["time" => "", "start" => "S12", "dest" => "S18", "condition" => "", "delay" => 55],
//    ["time" => "", "start" => "S18", "dest" => "BS4", "condition" => "", "delay" => ""],
    ["time" => "", "start" => "BS3", "dest" => "", "condition" => "N", "nextTrn" => "11", "delay" => "70"],
  ],
  "remarks" => "",
],
