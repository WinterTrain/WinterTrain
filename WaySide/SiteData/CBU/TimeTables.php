...
"21" => [
  ...
  "routeTable" => [
    ...
    ["time" => "**:*6*00", "start" => "S17", "dest" => "S11", "condition" => "", "delay" => ""],
...
"22" => [
  ...
  "group" => "",
  "routeTable" => [
    ["time" => "**:*0:00", "start" => "S10", "dest" => "S16", "condition" => "", "delay" => ""],
    ["time" => "", "start" => "S16", "dest" => "S20", "condition" => "", "delay" => ""],
    ["time" => "", "start" => "S20", "dest" => "S24", "condition" => "", "delay" => ""],
    ["time" => "**:*3:30", "start" => "S24", "dest" => "BS2", "condition" => "", "delay" => ""],
    ["time" => "", "start" => "S19", "dest" => "S15", "condition" => "", "delay" => 20],
    ["time" => "", "start" => "S15", "dest" => "S33", "condition" => "", "delay" => ""],
    ["time" => "", "start" => "S13", "dest" => "S33", "condition" => "", "delay" => ""],
    ["time" => "", "start" => "S33", "dest" => "BS5", "condition" => "", "delay" => ""],
