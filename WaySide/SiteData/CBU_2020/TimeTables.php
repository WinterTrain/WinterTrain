...
//    ["time" => "", "start" => "S17", "dest" => "S11", "condition" => "", "delay" => ""],
    ["time" => "", "start" => "S17", "dest" => "S13", "condition" => "", "delay" => ""],
...
"12" => [
  ...
  "routeTable" => [
    ...
    ["time" => "", "start" => "S12", "dest" => "S16", "condition" => "", "delay" => 55],
    ["time" => "", "start" => "S16", "dest" => "S18", "condition" => "", "delay" => ""],
...
"21" => [
  ...
  "routeTable" => [
    ...
    ["time" => "", "start" => "S1", "dest" => "BS1", "condition" => "", "delay" => ""],
    ["time" => "", "start" => "BS1", "dest" => "", "condition" => "N", "nextTrn" => "22", "delay" => 80],
  ],
  "remarks" => "",
],
...
"22" => [
  ...
  "routeTable" => [
    ...
    ["time" => "", "start" => "S14", "dest" => "S16", "condition" => "", "delay" => 55],
    ["time" => "", "start" => "S16", "dest" => "S18", "condition" => "", "delay" => ""],
