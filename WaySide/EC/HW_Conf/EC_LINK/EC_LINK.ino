...
#define N_PDEVICE 0
#define N_PREG 0
#define UDEVICE_PIN[N_UDEVICE] {5, A1, 6, 9, 8}
#define PDEVICE_ON_MASK[N_PDEVICE] {} // Mask to set device on
#define PDEVICE_POL_MASK[N_PDEVICE] {} // Mask to set device reversed polarity
#define PDEVICE_REG[N_PREG] {} // Assignment of device to shift register
#define LDEVICE_REG[N_LREG] {} // Assignment of device to shift register
